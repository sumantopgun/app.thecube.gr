        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-footer">
              <form class="form-horizontal1 <?php echo $issuemsg->status; ?>" action="<?php echo base_url(); ?>users/issuechatby" method="post">
                <input type="hidden" class="form-control" name="issueID" value="<?php echo $issuemsg->issueID; ?>">
                <input type="hidden" class="form-control" name="senderUsername" value="<?php echo $issuemsg->assignBy; ?>">
            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                ...
                <li class="item">
                  ...
                  <div class="product-info">
                    <a href="javascript:void(0)" class="product-title">Assign To</a>
                    <span class="product-description">
                          <?php echo $issuemsg->assignTo; ?>
                        </span>
                  </div>
                </li>
