      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <div class="inner">
            <!-- count($data['no_of_contracts'])) -->
              <h3><?php if($no_of_contracts){
                echo count($no_of_contracts);
              } ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <div class="inner">
              ...
              <h3><?php if($no_of_users){
                echo count($no_of_users);
              } ?></h3>
