...
<head>
  ...
  <title>Cubeapp | Registration Page</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="#"><b>Users</b>Registration</a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <form action="<?php echo base_url();?>users/registration" method="post">
      <div class="form-group has-feedback">
        <input type="hidden" class="form-control" name="referral" value="<?php echo $referral; ?>">
      ...
      <!-- <div class="form-group has-feedback">
        <select name="membership_type" id="membership_type" class="form-control">
              <option value="none" selected="" disabled="">Select Membership Type</option>
              <?php
      ...
      <div class="form-group has-feedback">
        <input type="number" class="form-control" id="telno" name="telno" placeholder="Telephone No" min="0" required="">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
